...
const ColorPallete = (_props?: any) => {
  ...
  const handleChange = (selected: 'light' | 'dark' | 'system') => {
    setTheme(selected ? selected : 'light')
    setShow(false)
  }
  ...
  return (
    ...
    <div className={`dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle ${theme ?? 'system'}`}>
